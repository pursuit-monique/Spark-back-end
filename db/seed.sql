...
INSERT INTO users ( name, gender, about, profile, mood, theme, has_tasks, has_blockers ) VALUES 
('Luigi', 'male', 'I''m an extremely sweet, affectionate cat that is quite chatty.', 'https://thumbs.dreamstime.com/b/young-brown-bicolor-domestic-cat-26897614.jpg', 1, 'primary', true, true);
...
INSERT INTO blockers ( 
   ...
   1, 'I tend to be self-conscious', 'Because I''m a monster /n because I enjoy having fun /n because i eat all the food.'
);
